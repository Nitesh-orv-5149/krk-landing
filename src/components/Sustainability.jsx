      ...
      <div className="wrap">
        ...
        <div className="policy-box rv">
          <div className="policy-head">
            ...
            <button className="ph-expand" onClick={expandAll}>
              📄 Expand All Sections
            </button>
          </div>
          ...
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[0] ? 'open' : ''}`} onClick={() => toggleSection(0)}>
          ...
          {/* Section 02 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[1] ? 'open' : ''}`} onClick={() => toggleSection(1)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 03 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[2] ? 'open' : ''}`} onClick={() => toggleSection(2)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 04 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[3] ? 'open' : ''}`} onClick={() => toggleSection(3)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 05 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[4] ? 'open' : ''}`} onClick={() => toggleSection(4)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 06 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[5] ? 'open' : ''}`} onClick={() => toggleSection(5)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 07 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[6] ? 'open' : ''}`} onClick={() => toggleSection(6)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 08 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[7] ? 'open' : ''}`} onClick={() => toggleSection(7)}>
              <div className="pol-toggle-left">
          ...
          {/* Section 09 */}
          <div className="pol-row">
            <button className={`pol-toggle ${openSections[8] ? 'open' : ''}`} onClick={() => toggleSection(8)}>
              <div className="pol-toggle-left">
